...
function amarelo(){
    semafaro.src ="./imagem/luz(2).jpeg";
}

let semafaroState = 'vermelho'; 

function alternarSemaforo() {
  if (semafaroState === 'vermelho') {
    verde();
    semafaroState = 'verde';
  } else if (semafaroState === 'verde') {
    amarelo();
    semafaroState = 'amarelo';
  } else if (semafaroState === 'amarelo') {
    vermelho();
    semafaroState = 'vermelho';
  }
}
setInterval(alternarSemaforo, 1000);
