...
const BackgroundStars = memo(
  () => {
    ...
    useEffect(() => {
      ...
      // Create shooting stars periodically (never more than one chain at a time)
      ...
      // Schedule the first shooting star after an initial delay too,
      // so nothing bursts the instant the page loads
      shootingStarTimeoutRef.current = setTimeout(createShootingStar, Math.random() * 4000 + 2000);
