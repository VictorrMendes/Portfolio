...
import { ArrowUp } from "lucide-react"; // Mantemos apenas o ícone de UI

// Componentes SVG puros para as marcas (Blindados contra erros de importação)
const GithubIcon = () => (
        ...
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:items-start">
          ...
          <div className="flex flex-col items-center md:items-start gap-4 text-center md:text-left">
            <div className="flex items-center gap-3 cursor-pointer" onClick={scrollToTop}>
              ...
              <span className="font-pixel text-lg text-white neon-text">VMS_SYSTEM</span>
            </div>
